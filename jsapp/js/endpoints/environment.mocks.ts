...
const environmentResponse: EnvironmentResponse = {
  ...
  support_email: 'soporte@data.umsa.bo',
  support_url: 'https://data.umsa.bo/docs/',
  academy_url: 'https://data.umsa.bo/docs/guides/inicio-rapido/',
  community_url: 'https://data.umsa.bo/docs/',
  ...
  user_metadata_fields: [
    ...
    },
    {
      ...
      required: false,
      label: 'I want to receive occasional updates about DataUMSA',
    },
  ],
  social_apps: [],
